...
const RightContent = () => {
  ...
  return (
    <>
      <section className="leading-loose" id="about">
          <p className="mb-3">
      ...
      <section className="pt-[5rem]" id="work-experience">
        <h1 className="text-2xl font-bold mb-3" id="work-experience-heading">Work Experiences</h1>
        {
      ...
      <section className="h-screen pt-[5rem]" id="projects">
          <h1 className="text-2xl font-bold mb-3" id="projects-heading">Projects</h1>
          
          
      </section>
      
      <section className="h-screen pt-[5rem]" id="blog">
          <h1 className="text-2xl font-bold mb-3" id="blog-heading">Blogs</h1>
