...
const TechStack = () => {
    const techStack = [
        ...
        <a href="https://vuejs.org/" target="_blank" rel="noopener noreferrer">
            <i className="devicon-vuejs-plain text-4xl" title="Vue"></i>
        </a>,
        ...
        <a href="https://nuxt.com/" target="_blank" rel="noopener noreferrer">
            <i className="devicon-nuxtjs-plain text-4xl" title="Nuxt.js"></i>
        </a>,
        <a href="https://www.electronjs.org/" target="_blank" rel="noopener noreferrer">
            <i className="devicon-electron-original text-4xl" title="Electron.js"></i>
        </a>,
        ...
        function addAnimation() {
            ...
            scrollers.forEach((scroller) => {
                ...
                const scrollerContent = Array.from(
                    scrollerInner?.children as HTMLCollectionOf<HTMLElement>
                );
